...
parser.add_argument("-dr", "--default_refer_path", type=str, default="./reference_audio/说话—既然罗莎莉亚说足迹上有元素力，用元素视野应该能很清楚地看到吧。.wav", help="默认参考音频路径")
parser.add_argument("-dt", "--default_refer_text", type=str, default="说话—既然罗莎莉亚说足迹上有元素力，用元素视野应该能很清楚地看到吧。", help="默认参考音频文本")
