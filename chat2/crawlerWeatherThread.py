...
class WeatherCrawler:
    ...
    def start(self, provinces):
        ...
        with concurrent.futures.ThreadPoolExecutor(10) as executor:
            for data in weather_data:
                if data['province_name'] == provinces:  # 限定城市
                    executor.submit(self.get_text, data['province_name'], data['city_name'], data['county_name'],
                                    self.base_url + data['weather_code'] + '.shtml')
